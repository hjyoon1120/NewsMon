					...
					<div class="box-body">
						<div class="form-group">
							<label>TITLE</label> <input type="text" name="title"
								class="form-control" value="${enmNewsVO.title}" /> <label>SUBTITLE</label>
							<input type="text" name="subtitle" class="form-control"
								value="${enmNewsVO.subtitle}" />
							<div class="row">
								<div class="col-xs-4">
									<label>PRESS</label> <input type="text" name="press"
										class="form-control" value="${enmNewsVO.press}" />
								</div>
								<div class="col-xs-4">
									<label>REPOTER</label> <input type="hidden" name="reporter_id"
										class="form-control" value="${enmNewsVO.reporter_id}" readonly/>
										<input type="text" name="nickname"
										class="form-control" value="${enmNewsVO.nickname}" readonly/>
								</div>
							</div>
							<hr>
							<label>CONTENT</label>
							<textarea class="form-control" name="content" rows="10">${enmNewsVO.content}</textarea>
							...
							<label>QUERY</label> <input type="text" name="query"
								class="form-control" value="${enmNewsVO.query}" />
						</div>
					</div>
					<!-- /.box-body -->
				</form>
	...
	$(document).ready(function() {
		...
		$(".btn-warning").on("click", function() {
			...
			if (confirm(msg) != 0) {
				...
				self.location = "/enm/?page=${cri.page}&perPageNum=${cri.perPageNum}&keyword=${cri.keyword}";
