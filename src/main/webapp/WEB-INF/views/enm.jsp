		...
		<div class="col-md-8">
			<div class="box box-success">
				...
				<div class="box-footer">
					<div class="info-box">
						<div>
							<span class="text-muted">찬성 : 63% /
								${enmNewsVO.votecnt_positive}명</span> <span
								class="text-muted pull-right">반대 : 37% /
								${enmNewsVO.votecnt_negative}명</span>
						</div>
