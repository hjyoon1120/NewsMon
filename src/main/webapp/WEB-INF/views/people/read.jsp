...
<section class="content">
	<div class="row">
		<form role="form" method="post">
			<input type='hidden' name='pno' value="${peopleNewsVO.pno}">
		...
		<div class="col-md-8">
			<div class="box box-success">
				<div class="box-header with-border">
					...
					<small> <i class="fa fa-pencil"></i>&nbsp;${peopleNewsVO.press}
						&nbsp;|&nbsp; ${peopleNewsVO.nickname}
					</small> &nbsp;-&nbsp; <span class="description"> <i
						class="fa fa-clock-o"></i> <fmt:formatDate
							pattern="yyyy-MM-dd HH:mm" value="${peopleNewsVO.regdate}" />
						&nbsp;|&nbsp;<b>UPDATED</b> <fmt:formatDate
							pattern="yyyy-MM-dd HH:mm" value="${peopleNewsVO.uptdate}" />
					</span>
					<div class="box-tools pull-right">
						<button class='btn btn-box-tool' id='backBtn'><a href="/people/list/">
							<i class='fa fa-chevron-left'></i></a>
						</button>
						<c:if test="${login.uid == peopleNewsVO.reporter_id }">
					...
					<br>
					<h1>${peopleNewsVO.title}</h1>
					<span class="description">${peopleNewsVO.subtitle}</span>
				</div>
				...
				<div class="box-body no-padding">
					<div class="mailbox-read-message">${peopleNewsVO.content}</div>
				...
				<div class="box-footer">
					<div>
						...
						<span class="pull-right text-muted"><span id="replyCnt">${peopleNewsVO.replycnt}</span>&nbsp;<i class="fa fa-commenting"></i></span>
				...
				<div class="box-footer">
					<div class="info-box">
						...
						<span class="text-muted">
							찬성:&nbsp;&nbsp;<span id = "positiveRate">${peopleNewsVO.vote_rate}</span>%&nbsp;&nbsp;|&nbsp;&nbsp;<span>${peopleNewsVO.votecnt_positive}명</span>
						</span>
						<span class="text-muted pull-right">
							반대:&nbsp;&nbsp;<span id = "negativeRate"></span>%&nbsp;&nbsp;|&nbsp;&nbsp;
							<span class="text-muted pull-right">${peopleNewsVO.votecnt_negative}명</span>
						</span>
						</div>
						<div class="info-box bg-light-blue-gradient"
							style="width: ${peopleNewsVO.vote_rate}%; float: left;">
...
<script>
	...
	$("#pagination").on("click", "li a", function(event) {
		...
		getPage("/people_replies/" + pno + "/" + replyPage);
	});
...
<script>
	...
	$(document).ready(function() {
		...
		$("#modifyBtn").on("click", function() {
			formObj.attr("action", "/people/modify");
		...
		$("#removeBtn").on("click", function() {
			...
			if(replyCnt > 0){
				...
				if (confirm(msg) != 0) {
					...
					if(arr.length > 0) {
						$.post("/people_delAll", {files:arr}, function(){
							
						});
					}
					
					formObj.attr("action", "/people/remove");
					formObj.submit();
				} else {
					return;
				}
...
/* 		$("#backBtn").on("click", function() {
		...
		function calcRate(){
			var negativeRate = 100 - ${peopleNewsVO.vote_rate};
