...
<section class="content">
	<div class="row">
		<form role="form" method="post">
			<input type='hidden' name='sno' value="${societyNewsVO.sno}">
		...
		<div class="col-md-8">
			<div class="box box-success">
				<div class="box-header with-border">
					...
					<small> <i class="fa fa-pencil"></i>&nbsp;${societyNewsVO.press}
						&nbsp;|&nbsp; ${societyNewsVO.nickname}
					</small> &nbsp;-&nbsp; <span class="description"> <i
						class="fa fa-clock-o"></i> <fmt:formatDate
							pattern="yyyy-MM-dd HH:mm" value="${societyNewsVO.regdate}" />
						&nbsp;|&nbsp;<b>UPDATED</b> <fmt:formatDate
							pattern="yyyy-MM-dd HH:mm" value="${societyNewsVO.uptdate}" />
					</span>
					<div class="box-tools pull-right">
						<button class='btn btn-box-tool' type="submit" id='backBtn'><a href="/society/list/">
							<i class='fa fa-chevron-left'></i></a>
						</button>
						<c:if test="${login.uid == societyNewsVO.reporter_id }">
					...
					<br>
					<h1>${societyNewsVO.title}</h1>
					<span class="description">${societyNewsVO.subtitle}</span>
				</div>
				...
				<div class="box-body no-padding">
					<div class="mailbox-read-message">${societyNewsVO.content}</div>
				...
				<div class="box-footer">
					<div>
						...
						<span class="pull-right text-muted"><span id="replyCnt">${societyNewsVO.replycnt}</span>&nbsp;<i class="fa fa-commenting"></i></span>
				...
				<div class="box-footer">
					<div class="info-box">
						...
						<span class="text-muted">
							찬성:&nbsp;&nbsp;<span id = "positiveRate">${societyNewsVO.vote_rate}</span>%&nbsp;&nbsp;|&nbsp;&nbsp;<span>${societyNewsVO.votecnt_positive}명</span>
						</span>
						<span class="text-muted pull-right">
							반대:&nbsp;&nbsp;<span id = "negativeRate"></span>%&nbsp;&nbsp;|&nbsp;&nbsp;
							<span class="text-muted pull-right">${societyNewsVO.votecnt_negative}명</span>
						</span>
						</div>
						<div class="info-box bg-light-blue-gradient"
							style="width: ${societyNewsVO.vote_rate}%; float: left;">
...
<script>
	...
	$(".pagination").on("click", "li a", function(event) {
		...
		getPage("/society_replies/" + sno + "/" + replyPage);
	});
...
<script>
	...
	$(document).ready(function() {
		...
		$("#modifyBtn").on("click", function() {
			formObj.attr("action", "/society/modify");
		...
		$("#removeBtn").on("click", function() {
			...
			if(replyCnt > 0){
				...
				if (confirm(msg) != 0) {
					...
					if(arr.length > 0) {
						$.post("/society_delAll", {files:arr}, function(){
							
						});
					}
					
					formObj.attr("action", "/society/remove");
					formObj.submit();
				} else {
					return;
				}
...
/* 		$("#backBtn").on("click", function() {
		...
		function calcRate(){
			var negativeRate = 100 - ${societyNewsVO.vote_rate};
