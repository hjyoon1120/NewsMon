		...
		<div class="col-md-8">
			<div class="box box-success">
				<div class="box-header with-border">
					<h3 class="box-title">Culture News List</h3>
				...
				<div class="box-body">
					<table class="table table-bordered">
						...
						<c:forEach items="${list}" var="cultureNewsVO">
							<script>
								$(document).ready(function(){
									...
									$.getJSON("/culture/getAttach/" + cno, function(list){
										$(list).each(function(){
											...
											$(".clearfix${cultureNewsVO.cno}").prepend(html);
										});
									});
								});
							</script>
							...
							<tr>
								<td>${cultureNewsVO.cno}</td>
								<td><a
									href='/culture/read${pageMaker_ten.makeSearch(pageMaker_ten.cri_ten.page) }&cno=${cultureNewsVO.cno}'>
										${cultureNewsVO.title} </a></td>
								<td>${cultureNewsVO.nickname}</td>
								<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm"
										value="${cultureNewsVO.regdate}" /></td>
								<td><span class="badge bg-red">${cultureNewsVO.viewcnt }</span></td>
								<td><div class="clearfix${cultureNewsVO.cno}"></div></td>
							</tr>
