...
<section class="content">
	<div class="row">
		<form role="form" method="post">
			<input type='hidden' name='sno' value="${sportsNewsVO.sno}">
		...
		<div class="col-md-8">
			<div class="box box-success">
				<div class="box-header with-border">
					...
					<small> <i class="fa fa-pencil"></i>&nbsp;${sportsNewsVO.press}
						&nbsp;|&nbsp; ${sportsNewsVO.nickname}
					</small> &nbsp;-&nbsp; <span class="description"> <i
						class="fa fa-clock-o"></i> <fmt:formatDate
							pattern="yyyy-MM-dd HH:mm" value="${sportsNewsVO.regdate}" />
						&nbsp;|&nbsp;<b>UPDATED</b> <fmt:formatDate
							pattern="yyyy-MM-dd HH:mm" value="${sportsNewsVO.uptdate}" />
					</span>
					<div class="box-tools pull-right">
						<button class='btn btn-box-tool' id='backBtn'><a href="/sports/list/">
							<i class='fa fa-chevron-left'></i></a>
						</button>
						<c:if test="${login.uid == sportsNewsVO.reporter_id }">
					...
					<br>
					<h1>${sportsNewsVO.title}</h1>
					<span class="description">${sportsNewsVO.subtitle}</span>
				</div>
				...
				<div class="box-body no-padding">
					<div class="mailbox-read-message">${sportsNewsVO.content}</div>
				...
				<div class="box-footer">
					<div>
						...
						<span class="pull-right text-muted"><span id="replyCnt">${sportsNewsVO.replycnt}</span>&nbsp;<i class="fa fa-commenting"></i></span>
				...
				<div class="box-footer">
					<div class="info-box">
						...
						<span class="text-muted">
							찬성:&nbsp;&nbsp;<span id = "positiveRate">${sportsNewsVO.vote_rate}</span>%&nbsp;&nbsp;|&nbsp;&nbsp;<span>${sportsNewsVO.votecnt_positive}명</span>
						</span>
						<span class="text-muted pull-right">
							반대:&nbsp;&nbsp;<span id = "negativeRate"></span>%&nbsp;&nbsp;|&nbsp;&nbsp;
							<span class="text-muted pull-right">${sportsNewsVO.votecnt_negative}명</span>
						</span>
						</div>
						<div class="info-box bg-light-blue-gradient"
							style="width: ${sportsNewsVO.vote_rate}%; float: left;">
...
<script>
	...
	$("#pagination").on("click", "li a", function(event) {
		...
		getPage("/sports_replies/" + sno + "/" + replyPage);
	});
...
<script>
	...
	$(document).ready(function() {
		...
		$("#modifyBtn").on("click", function() {
			formObj.attr("action", "/sports/modify");
		...
		$("#removeBtn").on("click", function() {
			...
			if(replyCnt > 0){
				...
				if (confirm(msg) != 0) {
					...
					if(arr.length > 0) {
						$.post("/sports_delAll", {files:arr}, function(){
							
						});
					}
					
					formObj.attr("action", "/sports/remove");
					formObj.submit();
				} else {
					return;
				}
...
/* 		$("#backBtn").on("click", function() {
		...
		function calcRate(){
			var negativeRate = 100 - ${sportsNewsVO.vote_rate};
