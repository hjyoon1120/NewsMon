...
//Entertainment news values object
public class EnmNewsVO {

	private Integer eno, reporter_id;
	...
	public String toString() {
		return "EnmNewsVO [eno=" + eno + ", reporter_id=" + reporter_id + ", title=" + title + ", subtitle=" + subtitle
				+ ", content=" + content + ", press=" + press + ", query=" + query + ", viewcnt=" + viewcnt
