...
import com.newsmon.service.EnmReplyService;

@RestController
@RequestMapping("/enm_replies")
public class EnmReplyController {

	@Inject
	private EnmReplyService service;

	@RequestMapping(value = "", method = RequestMethod.POST)
	public ResponseEntity<String> register(@RequestBody EnmReplyVO vo) {
	...
	public ResponseEntity<List<EnmReplyVO>> list(@PathVariable("eno") Integer eno) {

		ResponseEntity<List<EnmReplyVO>> entity = null;
	...
	public ResponseEntity<Map<String, Object>> list(@PathVariable("eno") Integer eno,
		...
		try {
			...
			List<EnmReplyVO> list = service.listReply(eno, cri_ten);
	...
	public ResponseEntity<String> update(@PathVariable("rno") Integer rno, @RequestBody EnmReplyVO vo) {
